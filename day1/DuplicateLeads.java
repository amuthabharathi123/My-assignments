...
public class DuplicateLeads {
	public static void main(String[] args)
			...
			throws InterruptedException {
				...
				lead.findElement(By.id("createLeadForm_companyName")).sendKeys("testGround");
				lead.findElement(By.id("createLeadForm_firstName")).clear();
				lead.findElement(By.id("createLeadForm_firstName")).sendKeys("Nimalan");
				lead.findElement(By.name("submitButton")).click();
				String title1 = lead.getTitle();
